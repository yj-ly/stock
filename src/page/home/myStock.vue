        ...
        <div class="list_item" v-for="item in takeList">
          ...
          <div class="order_con">
            ...
            <div class="list_top" :style="{'width':calcWidth}">
              <!--@click="localUrl('positionDetails')"-->
            ...
            <div class="order_item" @click="localUrl('stockDeal',item,orderItem,index)" v-for="(orderItem,index) in item">
              ...
              <div class="order_right">
                ...
                <span class="add_txt position_txt">{{orderItem.num}}</span>
                <span class="fen">/</span>
                <!--<span class="add_txt">+</span>-->
                <!--<span class="drop_txt" style="display: none">-</span>-->
                <span class="add_txt">{{orderItem.usable_num}}</span>
              </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      localUrl(strUrl,item,orderItem,index) {
        if(orderItem.usable_num >= 100){
          this.$router.push({
            name: strUrl,
            params: {
              showNum: 1,
              canBuyNum: orderItem.usable_num,
              stockCode: orderItem.stock_combine_code,
              stockName: orderItem.stock_name,
              no: orderItem.no,
              stock_no: orderItem.stock_no
            }
          });
        }
      },
